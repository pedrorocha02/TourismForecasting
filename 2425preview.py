...
plt.plot(dataset['Date'][len(y_train):], y_pred_best, label='Valores Previstos (2022-2023)', linestyle='--')
...
plt.title('Comparação entre Valores Reais, Previstos e Previsões Futuras (SARIMAX)')
plt.legend()
plt.show()
