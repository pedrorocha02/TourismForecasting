...
metrics_df.to_excel('./Results/02_Randforest_Metrics.xlsx', index=False)

results_df = pd.DataFrame({
    'Actual': y_test.values,
    'Predicted': y_pred
})
results_df.to_excel('./Results/02_Randforest_Predictions.xlsx', index=False)

# Plot dos valores reais e previstos
plot(dataset,y,y_train,y_pred, 'Random Forest V2')