...
metrics_df.to_excel('./Results/03_SARIMAX_Metrics.xlsx', index=False)

results_df = pd.DataFrame({
    'Actual': y_test.values,
    'Predicted': y_pred_best.values
})
results_df.to_excel('./Results/03_SARIMAX_Predictions.xlsx', index=False)

# Plot dos valores reais e previstos
plot(dataset,y,y_train,y_pred, 'SARIMAX V3')